            ...
            {isPostCreationOn && (
                <div className=" bg-white rounded-xl">
                    <div className="flex justify-between">
                        ...
                        <span className="material-symbols-outlined cursor-pointer hover:text-blue-400" onClick={() => {setIsPostCreationOn(false); setPicture(null)}}>close</span>
                    </div>
                    ...
                    { console.log({picture}) }
                    <button className="w-full bg-blue-800 p-2 rounded-xl mt-2 text-white hover:bg-blue-500" onClick={handlePost}>Post</button>
                </div>
            )}
        </div>
